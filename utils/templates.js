...
.mso-container table {
  ...
  font-size: 32px;  /* equivalent to text-[32px] */
  color: var(--color-primary-800); /* Assuming primary-800 is a custom color variable */
}
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    ...
    <div class="fynd-heading">
  <i class="fynd-heading">Fynd</i>
</div>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; color: #00896b; line-height: 140%; text-align: left; word-wrap: break-word;">
...
<p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; color: #666666;">We have sent you this email in response to your request to reset your password on Fynd.</span></p>
<p style="font-size: 14px; line-height: 140%;"> </p>
...
<div align="left">
  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:52px; v-text-anchor:middle; width:205px;" arcsize="2%"  stroke="f" fillcolor="#00896b"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
    <a href="${link}" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #00896b; border-radius: 1px;-webkit-border-radius: 1px; -moz-border-radius: 1px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
...
<p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px; color: #ecf0f1;">noreply.fynd@gmail.com</span></p>
<p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px; color: #ecf0f1;">Nairobi, Kenya.</span></p>
  </div>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; color: #00896b; line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="line-height: 140%; text-align: center;"><span style="font-size: 14px; line-height: 19.6px;"><span style="color: #ecf0f1; font-size: 14px; line-height: 19.6px;">Fynd © 2024  All Rights Reserved.</span></span></p>
  </div>
